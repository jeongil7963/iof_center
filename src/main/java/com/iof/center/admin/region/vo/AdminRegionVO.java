package com.iof.center.admin.region.vo;
/*
 * 지역 정보 VO
 */
public class AdminRegionVO {
	...
	public AdminRegionVO() {
		super();
		// TODO Auto-generated constructor stub
	}


	public AdminRegionVO(int region_idx, String region_name, String region_addr, String region_code) {
		super();
	...
	public String toString() {
		return "AdminRegionVO [region_idx=" + region_idx + ", region_name=" + region_name + ", region_addr="
