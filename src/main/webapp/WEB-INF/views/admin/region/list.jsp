	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			<div class="box">
				...
				<form name="search" method="post" action="/admin/region/list">
					<div class="box-tools">
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-hover">
						...
						<c:forEach items="${list}" var="RegionVO">
							<tr>
								<th><input type="checkbox" name="checkRow" id="checkRow" value='${RegionVO.region_idx}'/></th>
								<td>${RegionVO.region_code}</td>
								<td><a href='<c:url value="modify?region_idx=${RegionVO.region_idx}" />'>${RegionVO.region_name}</a></td>
				...
				<div class="box-footer">
					<div class="pull-right">
						<button type="submit" class="btn btn-primary" id='adming_region_regist'>
							<i class="fa fa-pencil"></i> 등록
						</button>
					</div>
					<button type="reset" class="btn btn-default" id="admin_region_del" name="delBtn">
...
<script>
	$(document).ready(function() {
		$('#adming_region_regist').on("click", function(evt) {
			evt.preventDefault();
			self.location = "regist";
		});
		$("#admin_region_del").click(function() {
			alert("삭제할꼬얌");
