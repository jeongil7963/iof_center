                        		...
                        		<option value="false">선택해주세요.</option>
                        			<c:if test="${!empty region}">
										<c:forEach var="region" items="${region}" varStatus="i">
											<option class="region_chk" value="${region.region_idx}" />${region.region_name}
										</c:forEach>
									</c:if>
                    		</select>
                   		</div>
               ...
               <div class="form-group">
				...
				<div class="box-footer" >
					<div class="pull-right">
						...
						<input type="hidden" name="arduino_regist_bool" id="arduino_regist_bool" value="" />
    ...
    $(document).ready(function() {	
		...
		/* 	var chk_region = document.getElementsByName('region_idx');
			...
			*/
			...
			var bool = confirm("아두이노를 자동등록 하겠습니까?");
			if(bool ==true){
				bool = true;
				$("#arduino_regist_bool").val(bool);
