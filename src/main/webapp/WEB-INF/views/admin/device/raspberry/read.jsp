		...
		<div class="col-md-12 col-xs-12">
			...
			<div class="box box-info">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-4">
              			<p class="form-control">${ras.ras_name}</p>
               ...
               <div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">카메라  </label>
              		<div class="col-sm-4">
                        <p class="form-control">${ras.ras_camera_operatingtime}</p>
                     </div>
              	</div>
               ...
               <div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">관수  </label>
              		<div class="col-sm-4">
              			 <p class="form-control">${ras.ras_watering_operatingtime}</p>
                     </div>
              	</div>
					...
					<label for="inputPassword3" class="col-sm-2 control-label">유저 아이디</label>
						<div class="col-sm-8">
							<div class="col-sm-4" style="padding-left: 0px;" id="text">
								 <p class="form-control">${ras.user_id}</p>
							</div>
						</div>
				</div>
			</div>
				...
				<div class="box-footer" >
					...
					<input type="hidden" name ="idChk" id="idChk" />
						<a class="btn btn-primary" href="<c:url value='detail?ras_idx=${ras.ras_idx}'/>" >수정</a>
					</div>
