			...
			<div class="box">
				...
				<div class="box-body table-responsive no-padding">	
					...
					<table class="table table-hover">
						...
						<c:forEach items="${raspberryList}" var="ras">
							<tr>
								<th><input type="checkbox" value='${ras.ras_idx}' name="ras_idx"/></th>
								<td><a href="<c:url value='read?ras_idx=${ras.ras_idx}'/>" >${ras.ras_name}</a></td>
								<td>${ras.api_key}</td>
								<td>${ras.ras_camera_operatingtime}분</td>
								<td>${ras.ras_watering_operatingtime}분</td>
...
$(document).ready(function() {
	...
	$('#check_all').on("click", function(){
 	...
 	$("#seldel").click(function() {
	   document.fboardlist.action = "/admin/device/raspberry/delete";
	   document.fboardlist.method = "GET";
	   document.fboardlist.submit();
});
