	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			<div class="box">
				...
				<form name="search" method="post" action="/admin/user/list">
					<div class="box-tools">
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-hover">
						...
						<c:forEach items="${UserList}" var="UserVO">
							<tr>
								<th style="text-align: center"><input type="checkbox" name="checkRow" id="checkRow" value='${UserVO.user_id}' /></th>
								<td>${UserVO.user_name}</td>
								<td><a href="<c:url value='modify?user_id=${UserVO.user_id}'/>">${UserVO.user_id}</a></td>
								<td>${UserVO.user_email}</td>
								<td>${UserVO.user_createtime}</td>
							</tr>
						</c:forEach>
					</table>
				</div>
				...
				<div class="box-footer">
					<div class="pull-right">
						<button type="submit" class="btn btn-primary" id='adming_user_regist'>
...
<script>
	$(document).ready(function() {
		$('#adming_user_regist').on("click", function(evt) {
			evt.preventDefault();
