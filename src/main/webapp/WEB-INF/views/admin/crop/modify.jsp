		...
		<div class="col-md-12 col-xs-12">
			<div class="box box-info">
				<div class="box-header with-border">
					<h3 class="box-title">Modify Form</h3>
				</div>
				<!-- /.box-header -->
				<!-- form start -->
				<form class="form-horizontal" name=exf1 method="POST" action="modify">
					<input type="hidden" name="user_id" value="${sessionScope.user.user_id}">
					<input type="hidden" name="crop_idx" value="${crop.crop_idx}">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="crop_name" value="${crop.crop_timing}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="crop_timing" value="${crop.crop_timing}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="crop_soil" value="${crop.crop_soil}">
							</div>
						</div>
					</div>
					<!-- /.box-body -->
