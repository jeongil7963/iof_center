	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			<div class="box">
				...
				<form name="search" method="post" action="/admin/crop/list">
					<div class="box-tools">
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-hover">
						...
						<c:forEach items="${CropList}" var="AdminCropVO">
							<tr>
								<th style="text-align: center"><input type="checkbox" name="checkRow" id="checkRow" value='${AdminCropVO.crop_idx}' /></th>
								<td><a href="<c:url value='modify?crop_idx=${AdminCropVO.crop_idx}'/>">${AdminCropVO.crop_name}</a></td>
								<td>${AdminCropVO.crop_timing}</td>
								<td>${AdminCropVO.unit_name}</td>
								<td>${AdminCropVO.crop_soil}</td>							
							</tr>
						</c:forEach>
					</table>
				</div>
