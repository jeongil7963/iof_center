				...
				<form class="form-horizontal" method="post" action="regist">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="region_name" name="region_name" laceholder="지역명">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="region_addr" name="region_addr" placeholder="주소">
							</div>
						</div>
					</div>
					<!-- /.box-body -->
