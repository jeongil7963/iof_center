	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<div class="box box-info">
				...
				<input type="hidden" name="cell_idx" value="${cell.cell_idx}" >
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="region_addr" name="cell_name" value="${cell.cell_name }">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="regist_id" name="user_id" value="${cell.user_id }">
								<button type="submit" id="overlap" class="btn btn-default">유효검사</button>
							</div>
						</div>
					</div>
					<!-- /.box-body -->
