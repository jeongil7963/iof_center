	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			<div class="box">
				...
				<form name="search" method="post" action="/admin/cell/list">
					<div class="box-tools">
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-hover">
						...
						<c:forEach items="${CellList}" var="AdminCellVO">
							<tr>
								<th style="text-align: center"><input type="checkbox" name="checkRow" id="checkRow" value='${AdminCellVO.cell_idx}' /></th>
								<td>${AdminCellVO.region_name}</td>
								<td>${AdminCellVO.unit_name}</td>
								<td><a href="<c:url value='modify?cell_idx=${AdminCellVO.cell_idx}'/>">${AdminCellVO.cell_name}</a></td>
								<td>${AdminCellVO.crop_name}</td>
								<td>${AdminCellVO.user_id}</td>
							</tr>
						</c:forEach>
					</table>
				</div>
